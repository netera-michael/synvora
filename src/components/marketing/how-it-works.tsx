...
const steps = [
  ...
  },
  {
    ...
    description: "Link your existing Shopify store or let us help you set up a new one.",
    image: "gradient-2"
  },
  {
    number: "03",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 max-w-5xl sm:mt-20 lg:mt-24">
          <div className="relative">
            {/* Connecting line */}
            <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-synvora-primary via-synvora-accent to-synvora-primary hidden lg:block" />
                ...
                return (
                  ...
                  >
                    <div className={`grid gap-8 lg:grid-cols-2 lg:gap-16 items-center ${isEven ? '' : 'lg:flex-row-reverse'}`}>
                      {/* Content */}
                      <div className={`${isEven ? 'lg:pr-8' : 'lg:pl-8 lg:order-2'} relative`}>
                        {/* Step number badge */}
                        <div className="absolute -left-4 lg:left-0 -top-2 flex h-16 w-16 items-center justify-center rounded-full bg-white border-4 border-synvora-primary/20 shadow-lg">
                          <span className="text-2xl font-bold bg-gradient-to-br from-synvora-primary to-synvora-accent bg-clip-text text-transparent">
                            {step.number}
                          </span>
                        </div>

                        <div className="ml-16 lg:ml-0 pt-2">
                          <div className="inline-flex rounded-xl bg-gradient-to-br from-synvora-primary to-synvora-accent p-3 shadow-lg mb-4">
